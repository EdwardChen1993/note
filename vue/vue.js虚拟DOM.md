...
- - 因为 oldVnode 的子节点的 b,c,d 和 newVnode 的 x,b,c 的 key 相同，所以只做比较，如果发现文本节点内容没有发生变化，就不会进行更新 DOM 的操作，当遍历完毕后，会再把 x 插入到 DOM 上DOM 操作只有一次插入操作。
...
![image-20210906174220677](vue.js虚拟DOM.assets/image-20210906174220677.png)
