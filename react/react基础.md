...
<img src="./react基础.assets/1.png" width="70%"/>
...
<img src="./react基础.assets/2.png" width="70%"/>
...
<img src="./react基础.assets/6.png" width="70%"/>
...
受控组件和非受控组件都有其特点，应该根据需求场进行选择。在大多数情况下，推荐使用受控组件处理表单数据。如果表单在数据交互方面比简单，使用非受控表单，否则使用受控表单。
